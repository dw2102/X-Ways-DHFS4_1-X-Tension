...
#define XWF_VSPROP_HASHTYPE			11
#define XWF_VSPROP_HASHTYPE1		20
#define XWF_VSPROP_HASHTYPE2		21
#define XWF_VSPROP_SET_HASHTYPE1	25
#define XWF_VSPROP_SET_HASHTYPE2	26
...
LONG __stdcall XT_Init(DWORD/*CallerInfo*/ info, DWORD nFlags, HANDLE hMainWnd, struct LicenseInfo* pLicInfo);
